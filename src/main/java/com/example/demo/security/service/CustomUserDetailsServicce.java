...
import com.example.demo.persistence.repository.ApplicationUserRepository;
...
@Service
public class CustomUserDetailsServicce implements UserDetailsService {

    private final ApplicationUserRepository applicationUserRepository;

    @Autowired
    public CustomUserDetailsServicce(ApplicationUserRepository applicationUserRepository) {
