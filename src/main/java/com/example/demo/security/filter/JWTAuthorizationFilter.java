...
import static com.example.demo.security.filter.Constants.*;

public class JWTAuthorizationFilter extends BasicAuthenticationFilter {

    private final CustomUserDetailsServicce customUserDetailsServicce;

    public JWTAuthorizationFilter(AuthenticationManager authenticationManager, CustomUserDetailsServicce customUserDetailsServicce) {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationToken(HttpServletRequest request){
        ...
        String username = Jwts.parser().setSigningKey(SECRET)
                ...
                .getBody()
                .getSubject();
        UserDetails userDetails = customUserDetailsServicce.loadUserByUsername(username);
        ApplicationUser applicationUser = customUserDetailsServicce.loadApplicationUserByUsername(username);
